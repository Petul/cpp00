...
/*   Updated: 2024/11/16 12:21:42 by pleander         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Contact::Contact(std::string first_name, std::string last_name,
    ...
    : first_name_{first_name}, last_name_{last_name}, nickname_{nickname},
      phone_number_{phone_number}, darkest_secret_{darkest_secret}, initialized{true} {}
...
void Contact::print_short(size_t index, size_t fw) {
	std::cout << std::setw(fw) << index << "|" << std::setw(fw) << this->truncate_field(this->first_name_, fw)
	          << "|" << std::setw(fw)
	          << this->truncate_field(this->last_name_, fw) << "|"
	          << std::setw(fw) << this->truncate_field(this->nickname_, fw)
	          << std::endl;
}
